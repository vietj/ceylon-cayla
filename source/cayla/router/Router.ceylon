...
shared class Router(shared [Router,Mount]? rel = null) satisfies Correspondence<Integer, Router> & Iterable<Router, Nothing> {
	...
	doc "Render the path with the specified parameters, if a parameter is missing rendering cannot occur and null is returned"
	...
	doc "Return the path as a declaration"
